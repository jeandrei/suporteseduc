		...
		<div class="row gx-5">
			...
			<div class="col-lg-8">
				<div class="row gx-5 row-cols-1 row-cols-md-2">
					...
					<div class="col mb-5 h-100">
						<div class="feature bg-primary bg-gradient text-white rounded-3 mb-3"><i class="bi bi-question-square-fill"></i></div>
						<h2 class="h5"><a href="https://suporte.educapenha.com.br/recupera">Recuperar Senha</a></h2>
						<p class="mb-0">Receba a última senha válida do sistema betha em seu email.</p>
					</div>
